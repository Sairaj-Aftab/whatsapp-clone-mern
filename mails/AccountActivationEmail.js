...
export const AccountActivationEmail = async (email, data) => {
  ...
  const transport = nodemailer.createTransport({
    ...
    auth: {
      ...
      pass: "htvl eobk ewax drjw",
    },
  });
  await transport.sendMail({
    from: "WhatsApp <sairajaftab769@gmail.com>",
    subject: "Activate",
    to: email,
    html: `
...
<div align="center" class="alignment" style="line-height:10px"><img alt="I'm an image" src="https://static-00.iconduck.com/assets.00/whatsapp-icon-2040x2048-8b5th74o.png" style="display: block; height: auto; border: 0; max-width: 120px; width: 100%;" title="I'm an image" width="120"/></div>
</td>
</tr>
</table>
